...
<style lang="css"
  ...
  .loader-2:after {
    ...
    -webkit-animation: load-2 1.8s infinite ease-in-out;
    animation: load-2 1.8s infinite ease-in-out;
  }
  ...
  .loader-3 {
    ...
    -ms-transform: translateZ(0);
    transform: translateZ(0);
    -webkit-animation: load-3 1.7s infinite ease, round 1.7s infinite ease;
    animation: load-3 1.7s infinite ease, round 1.7s infinite ease;
  }
  ...
  .loader-4 {
    ...
    position: relative;
    text-indent: -9999em;
    -webkit-animation: load-4 1.3s infinite linear;
